...
function QuickNav() {
  return (
    <div className="quick-nav">
        <h2 className="quick-nav__title">Welcome to the Holy Trinity Macedono Bulgarian Christian Orthodox Church Admin Website</h2>
      <ul className="quick-nav__list">
        <li className="quick-nav__item">
          <NavLink className="quick-nav__link" to="/weekly-announcements/add-new">
            <img
              className="quick-nav__icon"
              src={announcement}
              alt="announcement icon"
            />
            <span className="quick-nav__text">Add New Weekly Announcement</span>
          </NavLink>
        </li>
        <li className="quick-nav__item">
